...
$reportTitle = "Visitas con Base en Enfermedad Específica";
$from = $_GET['from'];
$to = $_GET['to'];
...
$titlesArr = array(
	'N Serie', 'Fecha Visita', 'Nombre Paciente',
	'Direccion', '# Contacto', 'Enfermedad'
);
...
$pdf->Output('registro_visitas_por_enfermedad.pdf', 'I');
