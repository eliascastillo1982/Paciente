...
VALUES('$displayName', '$userName', '$encryptedPassword', '$targetFile');";
    ...
    $message = 'Ocurrió un fallo subiendo la imagen';
  }
...
<head>
  ...
  <title>Usuario - Sistema de Gestión de Pacientes</title>
          ...
          <div class="card-body">
            <form method="post" enctype="multipart/form-data">
              <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                  <label>Imagen</label>
                  <input type="file" id="profile_picture" name="profile_picture" required="required" class="form-control form-control-sm rounded-0" />
                </div>

                <div class="col-lg-1 col-md-2 col-sm-2 col-xs-2">
                  <label>&nbsp;</label>
                  <button type="submit" id="save_medicine" name="save_user" class="btn btn-primary btn-sm btn-flat btn-block">Guardar</button>
                </div>
              </div>
            </form>
          </div>
              ...
              <table id="all_users" class="table table-striped dataTable table-bordered dtr-inline" role="grid" aria-describedby="all_users_info">
                ...
                <thead>
                  <tr>
                    ...
                    <th class="p-1 text-center">Imagen</th>
                    <th class="p-1 text-center">Mostrar Imagen</th>
                    <th class="p-1 text-center">Usuario</th>
        ...
        if (userName !== '') {
          $.ajax({
            ...
            success: function(count, status, xhr) {
              if (count > 0) {
                showCustomMessage("Este nombre de usuario existe. por favor elige otro nombre de usuario");
