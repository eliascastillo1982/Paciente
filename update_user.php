...
<head>
  ...
  <title>Actualizar Información de Usuario - Sistema de Gestión de Pacientes</title>
        ...
        <div class="card card-outline card-primary rounded-0 shadow">
            ...
            <form method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                  ...
                  <input type="text" id="display_name" name="display_name" required="required" class="form-control form-control-sm rounded-0" value="<?php echo $row['display_name']; ?>" />
                </div>
                <br>
                <br>
                <br>
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
                  <label>Usuario</label>
                  <input type="text" id="username" name="username" required="required" class="form-control form-control-sm rounded-0" value="<?php echo $row['user_name']; ?>" />
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-10">
          ...
          <div class="row">
            ...
            <div class="col-lg-1 col-md-2 col-sm-2 col-xs-2">
              <button type="submit" id="save_user" name="save_user" class="btn btn-primary btn-sm btn-flat btn-block">Actualizar</button>
            </div>
          </div>
          </form>
        </div>
