...
<head>
  ...
  <title>Reportes - Sistema de Gestión de Pacientes</title>
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <div class="card card-outline card-primary rounded-0 shadow">
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-2">
                <label>&nbsp;</label>
                <button type="button" id="print_visits" class="btn btn-primary btn-sm btn-flat btn-block">Generar PDF</button>
              </div>
            </div>
          </div>
          <!-- /.card-body -->
        ...
        <div class="card card-outline card-primary rounded-0 shadow">
          <div class="card-header">
            <h3 class="card-title">Informe basado en la enfermedad entre dos fechas</h3>
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-2">
                <label>&nbsp;</label>
                <button type="button" id="print_diseases" class="btn btn-primary btn-sm btn-flat btn-block">Generar PDF</button>
              </div>
            </div>
          </div>
          <!-- /.card-body -->
      ...
      $("#print_visits").click(function() {
        ...
        if (from !== '' && to !== '') {
          ...
          if (win) {
            ...
            showCustomMessage('Permita las ventanas emergentes');
          }
        }
      });
