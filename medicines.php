...
<head>
  ...
  <title>Medicinas - Sistema de Gestión de Pacientes</title>
</head>
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
            ...
            <form method="post">
              <div class="row">
                ...
                <div class="col-lg-1 col-md-2 col-sm-2 col-xs-2">
                  <label>&nbsp;</label>
                  <button type="submit" id="save_medicine" name="save_medicine" class="btn btn-primary btn-sm btn-flat btn-block">Guardar</button>
                </div>
              </div>
            </form>
          </div>
      ...
      <section class="content">
        ...
        <div class="card card-outline card-primary rounded-0 shadow">
          <div class="card-header">
            <h3 class="card-title">Todas la Medicinas</h3>
        ...
        if (medicineName !== '') {
          $.ajax({
            ...
            success: function(count, status, xhr) {
              if (count > 0) {
                showCustomMessage("Este nombre de medicamento ya ha sido almacenado. Por favor elige otro nombre");
