...
<head>
  ...
  <title>Actualizar Información de Medicina - Sistema de Gestión de Pacientes</title>
            ...
            <form method="post">
              ...
              <div class="row">
                ...
                <div class="col-lg-1 col-md-2 col-sm-4 col-xs-12">
                  <label>&nbsp;</label>
                  <button type="submit" id="submit" name="submit" class="btn btn-primary btn-sm btn-flat btn-block">Actualizar</button>
                </div>
              </div>
            </form>
          </div>
