...
<head>
  ...
  <title>Actualizar Medicina - Sistema de Gestión de Pacientes</title>
            ...
            <form method="post">
              <div class="row">
                ...
                <div class="col-lg-1 col-md-2 col-sm-2 col-xs-2">
                  <button type="submit" id="save_medicine" name="save_medicine" class="btn btn-primary btn-sm btn-flat btn-block">Actualizar</button>
                </div>
              </div>
            </form>
          </div>
